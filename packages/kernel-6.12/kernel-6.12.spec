...
Source0: https://cdn.amazonlinux.com/al2023/blobstore/1e72b072f6dee49adeea116ed9605657d25421dfcb905ae92b93c1affe491468/kernel6.12-6.12.80-106.156.amzn2023.src.rpm
...
%if "%{_cross_arch}" == "x86_64"
Requires: (%{_cross_os}kmod-6.12-neuron if (%{_cross_os}variant-platform(aws) without (%{_cross_os}variant-flavor(nvidia) or %{_cross_os}variant-flavor(nvidia-fips))))
Requires: (%{_cross_os}kmod-6.12-neuron-inf1 if (%{_cross_os}variant-platform(aws) without (%{_cross_os}variant-flavor(nvidia) or %{_cross_os}variant-flavor(nvidia-fips))))
Requires: (%{_cross_os}kmod-6.12-neuron-extras if (%{_cross_os}variant-platform(aws) without (%{_cross_os}variant-flavor(nvidia) or %{_cross_os}variant-flavor(nvidia-fips))))
%endif
